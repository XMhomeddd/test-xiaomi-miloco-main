...
You can select from preset options (All Day, Daytime, Nighttime) or **Custom** to set a daily start/end time. Overnight ranges are supported (e.g. 22:00 to 06:30 next day).
